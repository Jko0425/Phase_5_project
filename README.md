...
These are time series data that may contain noise. [Mauna Loa Observatory](https://gml.noaa.gov/obop/mlo/aboutus/aboutus.html), which provided the carbon emission data for Hilo International Airport, is located near an active volcano. This will lead to spiked levels of carbon dioxide concentration. We can reduce the noise for both climate and carbon emission data by calculating the rolling mean.
